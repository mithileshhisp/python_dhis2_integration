...
logging.info("STFC MMU Event query")
current_time_start = datetime.now().strftime("%Y-%m-%d %H:%M:%S")
print( f" pushing event start . { current_time_start }" )
...
#oneDayBeforeTodayStartDate = "2024-09-20 00:00:00" 
#oneDayBeforeTodayStartDate = "2025-01-09 00:00:00"
todayEndDate = todayStartDate
