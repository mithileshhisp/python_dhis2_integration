...
from constants import LOG_FILE_TEI_ENROLLMENT_POST, LOG_FILE_EVENT_ERROR_LOG
...
logging.basicConfig(filename=LOG_FILE_TEI_ENROLLMENT_POST, level=logging.INFO, format="%(asctime)s - %(levelname)s - %(message)s")
