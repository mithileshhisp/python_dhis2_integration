...
from constants import LOG_FILE_EVENT_TO_EVENT_POST, LOG_FILE_EVENT_ERROR_LOG

# DHIS2 API credentials and URL

#"https://links.hispindia.org/ippf_co/api/"
#"https://bpr.ippf.org/api/"

#DHIS2_API_GET_URL = "https://links.hispindia.org/ippf_co/api/"
#DHIS2_AUTH_GET = ("*******", "*****")

#DHIS2_API_POST_URL = "https://links.hispindia.org/ippf_co/api/"
#DHIS2_AUTH_POST = ("*******", "******")


DHIS2_API_GET_URL = "https://uin.ippf.org/api/"
DHIS2_AUTH_GET = ("*******", "******")
...
logging.basicConfig(filename=LOG_FILE_EVENT_TO_EVENT_POST, level=logging.INFO, format="%(asctime)s - %(levelname)s - %(message)s")
...
def push_events_in_dhis2(session_post, event_payload, event_uid, row ):
    ...
    try:
        ...
        #print(f" event_post_url : {event_post_url}" )
        ...
        response = session_post.post(
            event_post_url,
            json=event_payload,      # <-- use json instead of data
            timeout=60
        )
...
event_to_event_post_excel_file_path = 'event_to_event_post_data_from_xlsx.xlsx'
